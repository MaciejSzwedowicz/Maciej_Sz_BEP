    ...
    for report in iterate_reports_ijson(json_path):
        try:
            ...
            insert_with_fields(cursor, "report", [
                ...
                "sendertype": safe_int(report.get("sendertype")),
                "senderorganization": report.get("senderorganization"),
                "receivertype": safe_int(report.get("receivertype")),
                "receiverorganization": report.get("receiverorganization"),
