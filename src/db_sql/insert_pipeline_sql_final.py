# Final script too long to display here. Please refer to the full file for implementation details.# Combine your original modular structure with updated logic
...
def insert_report_related(conn, report):
    ...
    report_data = {
        ...
        "sendertype": safe_int(report.get("sender", {}).get("sendertype")),
        "senderorganization": report.get("sender", {}).get("senderorganization"),
        "receivertype": safe_int(report.get("receiver", {}).get("receivertype")),
        "receiverorganization": report.get("receiver", {}).get("receiverorganization"),
        "primarysource_qualification": safe_int(report.get("primarysource", {}).get("qualification")),
        "primarysource_reportercountry": report.get("primarysource", {}).get("reportercountry"),
    ...
    for ref in report.get("primarysource", {}).get("literaturereference", []):
